...
if __name__=="__main__":
    ...
    if test1:
        ...
        # ========
        test1_DLM_inst = DLM_full_model(test1_y_seq, test1_D0, np.array([0]), np.array([[1]]))
        test1_DLM_inst.run()
    ...
    if test2:
        ...
        test2_true_D0 = DLM_model_container(100)
    ...
    if test3:
        ...
        test3_D0 = DLM_model_container(100)
        ...
        test3_DLM_inst = DLM_full_model_with_reference_prior(test3_y_seq, test3_D0)
        test3_DLM_inst.run()
    ...
    if test4:
        ...
        test4_true_D0 = DLM_model_container(100)
        ...
        test4_D0 = DLM_model_container(100)
